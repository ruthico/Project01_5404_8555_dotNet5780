...
namespace DS
{
    ...
    public class DataSource
    {
        ...
        {                              new HostingUnit(){Diary = Diary(), HostingUnitKey=11111111,  Owner =new Host() { HostKey = 200000001, PrivateName = "yael", FamilyName = "levi", FhoneNumber = 020000001, MailAddress = "yael@gmail.com" ,
                                       BankAccount = new BankBranch() { BankNumber = 111, BankName = Bank_Name.Discont, BranchNumber = 1111, BranchAddress = "beit hadfous 65", BranchCity = "Jerusalem", BankAccountNumber = 123111 } , CollectionClearance = false }
                                       ...
                                       new HostingUnit(){Diary = Diary(), HostingUnitKey=11111115,  Owner =new Host() { HostKey = 200000001, PrivateName = "yael", FamilyName = "levi", FhoneNumber = 020000001, MailAddress = "yael@gmail.com" ,
                                       BankAccount = new BankBranch() { BankNumber = 111, BankName = Bank_Name.Discont, BranchNumber = 1111, BranchAddress = "beit hadfous 65", BranchCity = "Jerusalem", BankAccountNumber = 123111 } , CollectionClearance = false }
                                       ,HostingUnitName="yy hotel", Area = AreasInTheCountry.דרום,Adults=2,Children=1,Pool= true ,Jacuzzi=false ,Garden=false},
                                       new HostingUnit(){Diary = Diary(), HostingUnitKey=11111112,  Owner =new Host() { HostKey = 200000002, PrivateName = "ruthi", FamilyName = "cohen", FhoneNumber = 02-0000002, MailAddress = "ruthi@gmail.com",
                                       BankAccount = new BankBranch() { BankNumber = 222, BankName = Bank_Name.Igood, BranchNumber = 2222, BranchAddress =  "kanfey nesharim 3", BranchCity = "Jerusalem", BankAccountNumber =123222 } , CollectionClearance = true }
                                       ...
                                       new HostingUnit(){Diary = Diary(), HostingUnitKey=11111113,  Owner =new Host() { HostKey = 200000003, PrivateName = "odelia", FamilyName = "melloul", FhoneNumber = 02-0000003, MailAddress = "odelia@gmail.com",
                                       BankAccount = new BankBranch() { BankNumber =333, BankName = Bank_Name.Igood, BranchNumber = 3333, BranchAddress =  "smilanski 14", BranchCity = "Netanya", BankAccountNumber = 123333 } , CollectionClearance =false } ,
        ...
        public static List<GuestRequest> guestRequestsList = new List<GuestRequest>(){new GuestRequest(){GuestRequestKey= Configuration.guestRequestKey++,PrivateName="yaniv",FamilyName="ashkenazi",MailAddress="odeliamel04@gmail.com",Status=OrderStatus.נשלח_מייל, RegistrationDate= new DateTime(2019,06,11),
                                                                                     ...
                                                                                     Garden= ChoosingAttraction.הכרחי,ChildrensAttractions= ChoosingAttraction.אפשרי, Its_Signed= true},
                                                                                     ...
                                                                                     Garden = ChoosingAttraction.לא_מעוניין,ChildrensAttractions = ChoosingAttraction.הכרחי,Its_Signed= true },
                                                                                     ...
                                                                                     Garden = ChoosingAttraction.הכרחי,ChildrensAttractions = ChoosingAttraction.אפשרי,Its_Signed= false },


                                                                                     new GuestRequest() {GuestRequestKey = Configuration.guestRequestKey++,PrivateName = "maeva",FamilyName = "melloul",MailAddress = "maevamel04@gmail.com",Status = OrderStatus.נסגרה_עסקה, RegistrationDate = new DateTime(2019,11,06),
                                                                                     EntryDate =  new DateTime(2019,03,22),ReleaseDate =new DateTime (2019,03,26),Area =  AreasInTheCountry.מרכז,SubArea =  All.נתניה,
                                                                                     Type = TypesOfVacation.קמפינג,Adults = 2,Children = 2,Pool =ChoosingAttraction.לא_מעוניין,Jacuzzi = ChoosingAttraction.לא_מעוניין,
                                                                                     Garden = ChoosingAttraction.הכרחי,ChildrensAttractions = ChoosingAttraction.אפשרי,Its_Signed= false }
        ...
        {                              {new Host() { HostKey = 200000001, PrivateName = "yael", FamilyName = "levi", FhoneNumber = 0585577022, MailAddress = "yael@gmail.com" ,
                                       BankAccount = new BankBranch() { BankNumber = 111, BankName = Bank_Name.Discont, BranchNumber = 1111, BranchAddress = "beit hadfous 65", BranchCity = "Jerusalem", BankAccountNumber = 123111 } , CollectionClearance = false }},

                                       {new Host() { HostKey = 200000002, PrivateName = "ruthi", FamilyName = "cohen", FhoneNumber = 0554466221, MailAddress = "ruthi@gmail.com",
                                       BankAccount = new BankBranch() { BankNumber = 222, BankName = Bank_Name.Igood, BranchNumber = 2222, BranchAddress =  "kanfey nesharim 3", BranchCity = "Jerusalem", BankAccountNumber =123222 } , CollectionClearance = true } },

                                       {new Host() { HostKey = 200000003, PrivateName = "odelia", FamilyName = "melloul", FhoneNumber = 0585588096, MailAddress = "odelia@gmail.com",
                                       BankAccount = new BankBranch() { BankNumber =333, BankName = Bank_Name.Igood, BranchNumber = 3333, BranchAddress =  "smilanski 14", BranchCity = "Netanya", BankAccountNumber = 123333 } , CollectionClearance =false } }
