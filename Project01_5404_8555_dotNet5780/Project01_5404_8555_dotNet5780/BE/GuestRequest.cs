...
namespace BE
{
        ...
        private bool its_Signed;

        public bool Its_Signed { get => its_Signed; set => its_Signed = value;}
        ...
        public override string ToString()
        {
            ...
            return GuestRequest += string.Format("Guest Request Key: {0}\n"+ "Name: {1} {2}\n"+ "Mail:{3}\n" + "ID:{4}\n" + "status: {5}\n" 
                ...
                RegistrationDate, EntryDate, ReleaseDate, Area, SubArea , Type, Adults,Children,Room,Pool,Jacuzzi,Garden, ChildrensAttractions ,Its_Signed, Breakfast, Lunch,Dinner);
